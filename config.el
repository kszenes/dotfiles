...
2. Through a org-capture popup frame that is invoked from outside Emacs (the
  ...
  (setq org-default-notes-file
        ...
        '(
          ...
          ("f" "Files" entry (file+headline "~/org/gtd.org" "Files")
           "* TODO %?\n  %i\n  %a" :empty-lines-after 1)
          ("c" "Calendar" entry (file+headline "~/org/gtd.org" "Agenda")
           "* TODO %?\n SCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+1d\")) " :empty-lines-after 1)
